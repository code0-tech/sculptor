...
const ErrorCodeDescription: Record<string, string> = {
    ...
    EXECUTION_USAGE_RECORDING_FAILED: "Usage recording failed",
    ...
    GENERATION_USAGE_RECORDING_FAILED: "AI usage recording failed",
    ...
    INVALID_FLOW_TYPE_LINK: "Invalid flow type link",
    ...
    INVALID_RUNTIME_FLOW_TYPE_SETTING: "Invalid flow type setting",
    ...
    INVALID_USER_NAMESPACE_PIN: "Invalid namespace pin",
    INVALID_USER_PROJECT_PIN: "Invalid project pin",
    ...
    NO_FLOW_TYPE_FOR_IDENTIFIER: "No flow type",
    ...
    TOTP_SECRET_NOT_SET: "TOTP not set up",
...
export default function RootLayout({children}: Readonly<{ children: React.ReactNode }>) {
    ...
    const toastHandler = (error: Error | GraphQLFormattedError) => {
        ...
        const message = (error && "errorCode" in error)
