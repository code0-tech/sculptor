...
import {IconCheck, IconMinus, IconSortAscending, IconSortDescending} from "@tabler/icons-react";
...
export const NamespaceProjectsView: React.FC = () => {
    ...
    const projects = React.useMemo(
        () => projectService.values({namespaceId: `gid://sagittarius/Namespace/${namespaceId}`}),
