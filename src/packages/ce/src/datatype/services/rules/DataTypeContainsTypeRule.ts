import {DataTypeRule, genericMapping, staticImplements} from "./DataTypeRule";
import type {
...
export class DataTypeContainsTypeRule {
    public static validate(value: NodeParameterValue, config: DataTypeRulesContainsKeyConfig, generics?: Map<string, GenericMapper>, flow?: Flow, dataTypeService?: DatatypeService): boolean {
